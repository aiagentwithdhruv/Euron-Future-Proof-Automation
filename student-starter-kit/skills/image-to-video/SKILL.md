---
name: image-to-video
description: Convert images and thumbnails to short AI video clips using Kling, Hailuo, Luma, Runway, Veo, Sora, and 5+ more tools. Use when user asks to animate an image, create a video from a photo, or convert a thumbnail to video.
