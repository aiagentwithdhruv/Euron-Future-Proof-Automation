...
If you require the absolute full schema breakdown, parameter options, or the complex JSON structing for multi-panel grids, refer to:
`master_prompt_reference.md` (in this skill's folder)
